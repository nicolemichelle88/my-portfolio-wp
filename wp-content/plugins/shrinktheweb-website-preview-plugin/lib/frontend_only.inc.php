 ...
 * [stwthumb link="true"]https://shrinktheweb.com[/stwthumb]
 * 
...
function STWWT_shortcode_showThumbnail($atts, $content) 
{
	...
	return STWWT_thumbnail_createThumbnail($content, $showLink, $size, $showFullLength, $custom_filename, $alt, $title, $screen);
}
