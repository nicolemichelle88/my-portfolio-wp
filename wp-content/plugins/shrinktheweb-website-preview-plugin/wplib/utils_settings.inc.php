...
/**
 * Set just a single setting to the settings list.
 * @param String $settingPrefix The string key used to store the array of settings.
 * @param String $settingName The name of the setting key for the individual setting to retrieve.
 * @param String $settingValue The value of the setting.
 * @return Boolean True if the setting was saved, false otherwise.
 */
if (!function_exists('TidySettings_setSettingSingle')) { function TidySettings_setSettingSingle($settingPrefix, $settingName, $settingValue)
{
	$settings = TidySettings_getSettings($settingPrefix);
	$settings[$settingName] = $settingValue;

	$result = TidySettings_saveSettings($settings, $settingPrefix);
	return $result;
}}
